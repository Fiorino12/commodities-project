function [price_6,CI_6]=Pricing_BasketOption_AVS(r,F0_2026,K,T,drift_2026,k_IG_2026, sigma_2026, theta_2026, Y_2026,...
...
%   CI_6       - Confidence interval for the estimated price.
    ...
    [dS_2026_1,dS_2026_2] = fastInverseGaussian(T, T^2/k_IG_2026, Nsim);
    XT_2026_1=drift_2026*T+Y_2026*(theta_2026*dS_2026_1+sigma_2026*sqrt(dS_2026_1).*Z_2026);
    XT_2026_2=drift_2026*T+Y_2026*(theta_2026*dS_2026_2+sigma_2026*sqrt(dS_2026_2).*Z_2026);
    ...
    [dS_2028_1,dS_2028_2] = fastInverseGaussian(T, T^2/k_IG_2028, Nsim);
    XT_2028_1=drift_2028*T+Y_2028*(theta_2028*dS_2028_1+sigma_2028*sqrt(dS_2028_1).*Z_2028);
    XT_2028_2=drift_2028*T+Y_2028*(theta_2028*dS_2028_2+sigma_2028*sqrt(dS_2028_2).*Z_2028);
    ...
    cov(max(FT_2026_1,FT_2028_1),max(FT_2026_2,FT_2028_2))
